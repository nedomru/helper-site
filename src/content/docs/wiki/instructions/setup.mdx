...
2.  Нажимаем **Установить**
    {" "}
    <img
      src="/domru-helper/images/setup-install.png"
      alt="Установить"
      width="350px"
...
3.  Нажимаем **Продолжить установку**
    <img
      src="/domru-helper/images/setup-continueinstall.png"
      alt="Продолжить установку"
      width="350px"
      style="border: 2px solid grey;"
    />
4.  Нажимаем **Добавить**
    <img
      src="/domru-helper/images/setup-add.png"
      alt="Добавить"
      width="350px"
      style="border: 2px solid grey;"
    />
