        ...
        "{724d1c91-059e-4392-8478-494513fc8241}": {
          updates: [
            ...
            },
            {
              version: "2.9.8.1",
              update_link:
                "https://github.com/nedomru/helper-site/releases/download/2.9.8.1/domhelper.xpi",
            },
            {
              version: "2.9.8.2",
              update_link:
                "https://github.com/nedomru/helper-site/releases/download/2.9.8.2/domhelper.xpi",
            },
          ],
        },
      },
